	...
	<div class="container">
		...
		<div class="books-image">
			...
			<div class="text-center">
				...
				<br> <strong class="bg-white display-2 bookbannertext">&nbsp;
					Book2Book &nbsp;</strong>
		...
		<div class="booksmargins">
			...
			<h2 id="booksavail" class="bg-white text-center">Books that are
				available to Borrow</h2>
